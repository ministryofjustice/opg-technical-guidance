        ...
        enterprise "Modernising Lasting Power of Attorney" {
            ...
            makeSoftwareSystem = softwareSystem "Modernising Lasting Power of Attorney" "Digital Lasting Power of Attorney infrastructure" {
                ...
                mlpaDraftingService = container "LPA Drafting Service" "Stores and manages data for pre-registration. [Owner: Modernising, Users: Vega]" "API Gateway, Go, DynamoDB" "Container" {
                    ...
                    mlpaDraftingServiceSiriusAPI = component "Case Management Integration API" "Managing Case Worker specific access" "API Gateway, Go" "Component"
                ...
                mlpaSiriusPublicAPI = container "Case Management Public API" "Interaction point between Case Management and other services. [Owner: Vega, Users: UaLPA, Modernising]" "API Gateway, Go" "Existing System"
                ...
                mlpaSiriusCaseManagement = container "Case Management (Sirius)" "Case Management for case working LPAs. [Owner: Vega, Users: Modernising]" "Go, HTML, CSS, JS" "Component" {
                    mlpaSiriusInternalAPI = component "Internal API" "" "API Gateway, PHP" "Existing System"
                    mlpaSiriusDatabase = component "Database" "Stores Case Management data." "AuroraDB" "Database Existing System"
                    mlpaSiriusMSPreRegistrationCaseManagement = component "Pre-Registered Case Management" "Microservice for Pre-Registered LPAs." "Go, HTML, CSS, JS"
                    mlpaSiriusMSRegisteredCaseManagement = component "Registered Case Management" "Microservice for Registered LPAs." "Go, HTML, CSS, JS"
                    mlpaSiriusMSPaperCaseManagement = component "Paper Channel Case Management" "Microservice for Paper Channel LPAs." "Go, HTML, CSS, JS"
                }
            }
        }
